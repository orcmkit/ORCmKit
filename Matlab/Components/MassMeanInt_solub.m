...
[rho_vap_1, rho_rl_1, rho_oil_1, rho_liq_1, ~] = R245fa_POE_density(T_K_1, P_Pa_1, zeta_r_1, fluid_r, fluid_lub, fit_ratio_rho, Tbubble_min_1, Tsat_pure_1);
[rho_vap_2, rho_rl_2, rho_oil_2, rho_liq_2, ~] = R245fa_POE_density(T_K_2, P_Pa_2, zeta_r_2, fluid_r, fluid_lub, fit_ratio_rho, Tbubble_min_2, Tsat_pure_2);
...
if 0.5*C_rv_1 + 0.5*C_rv_2 > 0 %there is a vapour phase
    ...
    if strcmp(param.correlation.type_void_fraction, 'LM') || strcmp(param.correlation.type_void_fraction, 'Premoli') || strcmp(param.correlation.type_void_fraction, 'Hughmark')
        [mu_vap_1, ~, ~, mu_liq_1] = R245fa_POE_viscosity(T_K_1, P_Pa_1, param.C_oil, zeta_r_1, rho_liq_1, rho_oil_1, rho_rl_1, fluid_r, fluid_lub, Tbubble_min_1, Tsat_pure_1);
        [mu_vap_2, ~, ~, mu_liq_2] = R245fa_POE_viscosity(T_K_2, P_Pa_2, param.C_oil, zeta_r_2, rho_liq_2, rho_oil_2, rho_rl_2, fluid_r, fluid_lub, Tbubble_min_2, Tsat_pure_2);
        param.mu_v = 0.5*mu_vap_1 + 0.5*mu_vap_2;
        param.mu_l = 0.5*mu_liq_1 + 0.5*mu_liq_2;
        param.sig = CoolProp.PropsSI('I', 'Q', 0, 'P', 0.5*P_Pa_1 + 0.5*P_Pa_2, fluid_r);
    end
    alpha_mean = VoidFraction_Integration(max(0,C_rv_1), max(0,C_rv_2), rho_vap_mean, rho_liq_mean, param);
