function [h_mix, h_rl, h_oil, h_rv, zeta_r, x, C_rl, C_rv] = TP_solubMixt(T_K, P_Pa, C_oil, fluid_r, fluid_lub, Tbubble_min, Tsat_pure)
% Function that finds properties of a oil-refrigerant mixture based
% on the temperature and pressure
if T_K > Tbubble_min % liquid + two-phase
    
    [zeta_r, res_zeta_r] = R245fa_POE_solubility(T_K , P_Pa);
