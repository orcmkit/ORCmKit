...
fit_DTP_zeta = [];
[h_mix, h_rl, h_oil, h_rv, zeta_r, x, C_rl, C_rv] = TP_solubMixt(T_K, P_Pa, C_oil, fluid_r, fluid_lub, Tbubble_min_K, Tsat_pure_K, fit_DTP_zeta);
zeta_oil = 1 - zeta_r;
res_zeta_r = 0;
[rho_vap, rho_rl, rho_oil, rho_liq, K] = R245fa_POE_density(T_K, P_Pa, zeta_r, fluid_r, fluid_lub, fit_ratio_rho, Tbubble_min_K, Tsat_pure_K);
[mu_vap, mu_rl, mu_oil, mu_liq] = R245fa_POE_viscosity(T_K, P_Pa, C_oil, zeta_r, rho_liq, rho_oil, rho_rl, fluid_r, fluid_lub, Tbubble_min_K, Tsat_pure_K);
