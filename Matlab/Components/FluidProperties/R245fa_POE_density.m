function [rho_vap, rho_rl, rho_oil, rho_liq, K] = R245fa_POE_density(T_K, P_Pa, zeta_r, fluid_r, fluid_lub, fit_ratio_rho, Tbubble_min, Tsat_pure)

if T_K >= Tbubble_min % The temperature is sufficiently high to permit a vapour phase
    
    if abs(T_K-Tsat_pure)<1e-3
