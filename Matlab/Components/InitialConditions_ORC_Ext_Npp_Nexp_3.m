...
if isfield(param, 'x0')
    ...
    out_x0 = FCT_ORC_Ext_Npp_Nexp_2(max(min(param.x0, [P_pp_ex_ub P_pp_su_ub h_ev_ex_ub]), [P_pp_ex_lb P_pp_su_lb h_ev_ex_lb])./[P_pp_ex_ub P_pp_su_ub h_ev_ex_ub], [P_pp_ex_lb P_pp_su_lb h_ev_ex_lb], [P_pp_ex_ub P_pp_su_ub h_ev_ex_ub], fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);  
