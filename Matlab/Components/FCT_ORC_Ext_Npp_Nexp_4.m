...
elseif param.DT_sc < 0
    if param.DT_sc >=-1 
        out.T_pp_su = CoolProp.PropsSI('T', 'P', out.P_pp_su, 'Q', 0, fluid_wf);
        out.h_pp_su = CoolProp.PropsSI('H', 'P', out.P_pp_su, 'Q', abs(param.DT_sc), fluid_wf);
        out.DT_sc = 0;
    elseif param.DT_sc < -1 
        out.T_pp_su = CoolProp.PropsSI('T', 'P', out.P_pp_su, 'Q', 0, fluid_wf) - (param.DT_sc+1);
        out.h_pp_su = CoolProp.PropsSI('H', 'P', out.P_pp_su, 'T', out.T_pp_su, fluid_wf);
