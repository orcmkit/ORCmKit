...
if not(isempty(res_ordered))
    ...
    options_fmincon = optimset('Disp','Iter','Algorithm','interior-point','Hessian','bfgs','GradObj','off','AlwaysHonorConstraints','bounds','UseParallel',true,'FinDiffType','forward','SubproblemAlgorithm','ldl-factorization','GradConstr','off','InitBarrierParam',1e-20,'TolX',1e-20,'TolFun',1e-20,'TolCon',1e-20,'MaxIter',10e2,'OutputFcn',@outputfunFS);    
