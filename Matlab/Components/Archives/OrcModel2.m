function [out_ORC, TS_ORC] = OrcModel2(fluid_wf, fluid_htf, in_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param)
%% CODE DESCRIPTION
...
if not(isempty(res_ordered))
    ...
    while not(stop) && k <= min(Nbr_comb_x0,Nbr_comb_x0_max);
        ...
        param.eval_type = 'fast';
        f = @(x) FCT_ORC_Ext_Npp_Nexp_res( x, lb, ub, fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);
        ...
        [out_ORC, TS_ORC] = FCT_ORC_Ext_Npp_Nexp(x, lb, ub, fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);
