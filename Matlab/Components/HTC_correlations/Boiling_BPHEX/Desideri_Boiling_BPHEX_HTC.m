function [h_boiling, Nu, flag] = Desideri_Boiling_BPHEX_HTC(x, rho_l, rho_v, rho, mu_l, k_l, sigma, G, Dh, disp_flag)
...
% INCONSISTENT FROM A NUMERICAL POINT OF VIEW !!!!!!!!!!!!!!! DECREASE IF X
% INCREASE ..... MUST BE CORRECTED
