...
IC = InitialConditions_ORC_Ext_Npp_Nexp_4(fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);
if max(param.init) <2
...
if not(isempty(res_ordered))
    ...
    %options_pattsearch = psoptimset&a('Display','iter','TolX', 1e-8, 'TolFun', 1e-8, 'TolMesh', 1e-8, 'MaxIter', 1e4, 'MaxFunEvals', 1e8, 'OutputFcns',@outputfunPS);
    ...
    while not(stop) && k <= min(Nbr_comb_x0,Nbr_comb_x0_max);
        ...
        f = @(x) FCT_ORC_Ext_Npp_Nexp_res_4( x, lb, ub, fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);
        ...
        [out_ORC, TS_ORC] = FCT_ORC_Ext_Npp_Nexp_4(x, lb, ub, fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);
