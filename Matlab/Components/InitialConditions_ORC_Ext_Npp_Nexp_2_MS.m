function IC = InitialConditions_ORC_Ext_Npp_Nexp_2_MS(fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param)
...
%                     ub_test = [P_pp_ex_guess_vec(index) P_pp_su_guess_vec(index) h_ev_ex_guess_vec(index) h_pp_su_guess_vec(index)];
                    ...
                    [guess, ~] = FCT_ORC_Ext_Npp_Nexp_2_MS(x_test, lb_test, ub_test, fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);
...
if isfield(param, 'x0')
    ...
    P_pp_su_guess_vec_x0 = min(max(P_pp_su_lb+1,min(param.x0(2), P_pp_su_ub-1)) + DP*x0_vec, P_pp_su_ub_vec_x0);
...
%         lb0_matrix =[P_pp_ex_lb_vec_x0' P_pp_su_lb_vec_x0' h_ev_ex_lb_vec_x0' h_pp_su_lb_vec_x0'];
         ...
         T_pp_su_guess_vec_x0 = param.x0(4)*ones(1,length(x0_vec));
%          x0_matrix = [P_pp_ex_guess_vec_x0' P_pp_su_guess_vec_x0' h_ev_ex_guess_vec_x0' h_pp_su_guess_vec_x0'];
%          ub0_matrix = [P_pp_ex_ub_vec_x0' P_pp_su_ub_vec_x0' h_ev_ex_ub_vec_x0' h_pp_su_ub_vec_x0'];
%          lb0_matrix =[P_pp_ex_lb_vec_x0' P_pp_su_lb_vec_x0' h_ev_ex_lb_vec_x0' h_pp_su_lb_vec_x0'];
    ...
    for k = 1:length(x0_vec)
        ...
        param.SUB.generateTS = 0;
        param.PRE.generateTS = 0;
        out_x0 = FCT_ORC_Ext_Npp_Nexp_2_MS(x0_matrix(k,:)./ub0_matrix(k,:), lb0_matrix(k,:), ub0_matrix(k,:), fluid_wf, fluid_htf, in_htf_su, T_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, T_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param);
