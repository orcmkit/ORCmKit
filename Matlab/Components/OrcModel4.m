function [out_ORC, TS_ORC] = OrcModel4(fluid_wf, fluid_htf, in_htf_su, P_htf_su, m_dot_htf, fluid_ctf, in_ctf_su, P_ctf_su, m_dot_ctf, T_amb, N_exp, N_pp, param)
%% CODE DESCRIPTION
...
Q_dot_rec_lb = 0;
P_cd_guess0 = linspace(CoolProp.PropsSI('P', 'Q', 0, 'T', T_ctf_su, fluid_wf),CoolProp.PropsSI('P', 'Q', 0, 'T', T_ctf_su+30, fluid_wf),3 );
x_rp_guess0 =  linspace(0.1, 0.9, 4);
x_Q_dot_rec_guess0 = linspace(0.1, 0.5, 4);
if strcmp(param.solverType, 'M_imposed')
    x_h_pp_su_guess0 = linspace(0.2, 0.8, 3);
